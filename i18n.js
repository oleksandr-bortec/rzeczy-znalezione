...
const translations = {
    pl: {
        ...
        search_subtitle: 'Centralna wyszukiwarka rzeczy znalezionych z calej Polski',
        ...
        // Profile Page
        profile_title: 'Profil uzytkownika',
        profile_subtitle: 'Zarzadzaj swoim profilem i ustawieniami konta',
        personal_info: 'Informacje osobiste',
        security: 'Bezpieczeństwo',
        settings: 'Ustawienia',
        activity: 'Aktywnosc',
        change_password: 'Zmiana hasla',
        change_password_desc: 'Regularnie zmieniaj haslo, aby zabezpieczyc swoje konto',
        current_password: 'Obecne haslo',
        new_password: 'Nowe haslo',
        confirm_password_label: 'Potwierdz nowe haslo',
        password_min_length: 'Minimum 8 znakow',
        active_sessions: 'Aktywne sesje',
        current_session: 'Biezaca sesja',
        logged_in: 'Zalogowano',
        language_interface: 'Jezyk interfejsu',
        save_settings: 'Zapisz ustawienia',
        danger_zone: 'Strefa niebezpieczna',
        deactivate_account: 'Dezaktywacja konta',
        deactivate_desc: 'Po dezaktywacji konta nie bedziesz mogl sie zalogowac',
        deactivate_button: 'Dezaktywuj konto',
        admin_panel: 'Panel administratora',

        // Admin Page
        admin_title: 'Panel Administratora',
        admin_subtitle: 'Zarzadzanie uzytkownikami i statystykami',
        user_management: 'Zarzadzanie uzytkownikami',
        total_users: 'Calkowita liczba uzytkownikow',
        active_users: 'Aktywni uzytkownicy',
        ...
        privacy: 'Prywatnosc',
        terms: 'Regulamin',
        loading_text: 'Ladowanie danych...',
        no_data: 'Brak danych',
        error_loading: 'Blad ladowania danych',
        try_again: 'Sprobuj ponownie',
        refresh: 'Odswież',
        apply: 'Zastosuj',
        reset: 'Resetuj',
        clear: 'Wyczysc',
        ...
        showing: 'Wyswietlanie',
        of: 'z',
        items_text: 'elementow',
        page: 'Strona',
        per_page: 'Na strone',
        first: 'Pierwsza',
        last: 'Ostatnia',
